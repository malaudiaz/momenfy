...
export const metadata: Metadata = {
  title: "Momenfy | Registro",
  description: "Momenfy página de registro",
  // other metadata
};
              ...
              <div className="px-26 py-17.5 text-center">
                <Link className="mb-5.5 inline-block" href="/">
                  ...
                  <Image
                    ...
                    src={"/images/logo/momenfy-dark.svg"}
                    alt="Logo"
                    width={176}
                    height={32}
                  />
